scoreboard players set #init dhud.settings 1

# If mob effect can affect HP display
scoreboard players set watch_mob_effect dhud.settings 1
...
# Read Absoption from player automatically
scoreboard players set read_absoption dhud.settings 1