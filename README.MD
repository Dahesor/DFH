...
Thus, data pack is allowed to modify player health with scoreboard commands and make arbitrary changes to vanilla signals before they take effects.
...
<details>
<summary>How to make a custom entity_hurt_player trigger 【Click to Expand】</summary>
