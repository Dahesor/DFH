...
* `$by_entity`: **(Read Only)** If this is caused by a `entity_hurt_player` advancement trigger, then this value is 1, if not, it is 0. Run `execute on attacker` to access the attacking entity.
